<task>
Run a security review of ALL code changes currently in the working tree.
...
Use ALLOW if there are no code changes or if you do not see a security issue.
Use BLOCK only if there are code changes and you found a security vulnerability that needs to be fixed before stopping.
</default_follow_through_policy>
