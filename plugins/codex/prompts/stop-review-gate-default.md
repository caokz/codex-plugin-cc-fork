<task>
Run a stop-gate review of ALL code changes currently in the working tree.
...
Challenge whether the work and its design choices should ship.
...
<dig_deeper_nudge>
If there are code changes, check for second-order failures, empty-state behavior, retries, stale state, rollback risk, and design tradeoffs before you finalize.
</dig_deeper_nudge>
